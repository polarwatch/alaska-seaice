...
# # Remove data from 09-15 to 09-18 in 2024
# nrt_df = subset(nrt_df, !(date >= as.Date("2024-09-15") & date <= as.Date("2024-09-18")))
...
#### This is for "plotly"
# # Break point
# dat_this = dat_this %>% mutate(date = as.Date(date, format = "%Y-%m-%d"))
# next_time = max(dat_this$date) + 0.5
# next_date = format(next_time, "%m-%d")
# dat_this = dat_this %>% bind_rows(data.frame(date = next_time, seaice_extent = NA, month_day = next_date))

# Reorder date
start_date = "2023-09-01"
end_date = "2024-08-31"
all_dates = format(seq(as.Date(start_date), as.Date(end_date), by = "day"), "%m-%d")
