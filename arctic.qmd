...
- Baseline daily extent time series (1985-2015) [Data](data/bs_extent_AlaskanArctic.csv) - [Metadata](data/bs_extent_README.md)
- Near-real-time daily extent of two recent years [Data](data/ext_recent_AlaskanArctic.csv) - [Metadata](data/nrt_extent_README.md) 
- Annual mean extent time series (1985-2024) [Data](data/AlaskanArctic_annual_extent.csv) - [Metadata](data/annualized_extent_README.md)  
