...
fig <- fig %>% layout(title = "Sea ice extent time series", hovermode = "x unified",
...
[Monthly sea ice extent data (1985-most recent year)](data/ebering_yearly.csv), [metadata](), and [white paper](whitepaper.html) are available.
