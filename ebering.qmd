...
- [Daily sea ice extent baseline time series (1985-2015)](data/bs_EasternBering.csv), [metadata](data/bs_README.txt)
- [Daily sea ice extent time series (current, last year)](data/ext_recent_EasternBering.csv), [metadata](data/ext_README.txt)
