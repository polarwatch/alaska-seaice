...
- Near-real-time daily extent of two recent years [Data](data/nrt_extent_NorthernBering.csv) - [Metadata](data/nrt_extent_README.md) 
- Annual mean extent time series (1985-2024) [Data](data/annualized_extent_NorthernBering.csv) - [Metadata](data/annualized_extent_README.md)  
