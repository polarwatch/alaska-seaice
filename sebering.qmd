...
The time series plot and data summary below present statistics on sea ice extent within southeastern Bering Sea
...
- Baseline daily extent time series (1985-2015) [Data](data/bs_extent_SoutheasternBering.csv) - [Metadata](data/bs_extent_README.md)
- Near-real-time daily extent of two recent years [Data](data/ext_recent_SoutheasternBering.csv) - [Metadata](data/nrt_extent_README.md) 
- Annual mean extent time series (1985-2024) [Data](data/SoutheasternBering_annual_extent.csv) - [Metadata](data/annualized_extent_README.md)  
