...
- Baseline daily extent time series (1991-2020) [Data](data/bs_extent_Southeastern.csv) - [Metadata](data/bs_extent_README.md)
- Near-real-time daily extent of two recent years [Data](data/nrt_extent_Southeastern.csv) - [Metadata](data/nrt_extent_README.md) 
- Annual mean extent time series (1985-2024) [Data](data/annualized_extent_Southeastern.csv) - [Metadata](data/annualized_extent_README.md)  
