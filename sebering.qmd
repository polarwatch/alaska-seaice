...
# last year based on 09-01 to 08-31
today <- Sys.Date()
...
# Set data based on dates for subsetting data
...
xaxis <- list(title = "Dates (MM-DD)",
            type = 'category',  # for ordering
            categoryorder = "array",  # Order type
            categoryarray = month_day_order,  # Order by custom month_day
            tickformat = "%m-%d",  # ticks in mm-dd format
