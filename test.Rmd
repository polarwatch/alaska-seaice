...
* Mean (1991-2020): Represents the average sea ice extent from 1991 to 2020.
* Upper and Lower Bounds of Error Band (1991-2020): Reflect the uncertainty of the Mean (1991 to 2020).
...
xaxis <- list(title = "Dates (MM-DD)",
  ...
  # Upper extent 
fig_bs <- plot_ly(baseline_df, x = ~month_day, y = ~seaice_extent_mean, type = 'scatter', 
              mode = 'lines',
              showlegend = FALSE, name = 'Baseline') %>%
         layout(title = "Sea ice extent time series", 
